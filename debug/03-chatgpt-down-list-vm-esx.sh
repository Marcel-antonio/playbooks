...
# === Dossiers à explorer ===
DIRS=(
  "/srv/nfs/docker-data/semaphore/playbooks/roles/03-down-list-vm-esx/"
)

# === Fichiers à inclure manuellement ===
FILES=(
  "/srv/nfs/docker-data/semaphore/playbooks/03-down-list-vm-esx.yml"
  "/srv/nfs/docker-data/semaphore/playbooks/03-down-list-vm-esx-inventory.yml"
